  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        CategoryPieCard(state: state, month: state.reportMonth),
        const SizedBox(height: 12),
        TopCategoryCard(state: state, month: state.reportMonth),
        const SizedBox(height: 12),
        CashflowForecastCard(state: state, now: state.reportMonth),
        const SizedBox(height: 12),
        MetricCard(
          title: 'Net cashflow',
